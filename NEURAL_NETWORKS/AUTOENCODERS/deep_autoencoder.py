...
autoencoder.fit(predictors_train, predictors_train, epochs=20, batch_size=256,   validation_data=(predictors_test, predictors_test))

original_dim = Input(shape=(784,))
l_enc = autoencoder.layers[0:3]
encoder = Model(original_dim, l_enc[2](l_enc[1](l_enc[0](original_dim))) )
encoder.summary()
