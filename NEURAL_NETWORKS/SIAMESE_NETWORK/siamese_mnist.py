...
X_train_sample, y_train_sample = get_sample(X_train, y_train, 300)
X_train_pairs, y_train_pairs = make_paired_dataset(X_train_sample, y_train_sample)

X_test_sample, y_test_sample = get_sample(X_test, y_test, 150)
...
model.compile(loss = 'binary_crossentropy', optimizer = opt.Adam(learning_rate=0.005), metrics=['accuracy'])
